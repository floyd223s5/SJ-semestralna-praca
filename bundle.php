...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT id, name, img_path, price, sale_price FROM bundles WHERE id = $bundle_id";
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="bundle-text col-lg-4 col-sm-12">
                    ...
                    <?php endif; ?>
                    <p>Tax Included</p>
                    <button class="add-to-cart" data-bundle-id="<?php echo $bundle_id; ?>">Add to Cart</button>
            ...
            <div class="row">
                <?php
                $sql = "SELECT id, name, img_path, price, sale_price FROM bundles WHERE id <> $bundle_id ORDER BY id DESC LIMIT 4";
                $result = $conn->query($sql);
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="col-lg-3 col-sm-12">
                            <div class="card bundle-card">
                                ...
                                <?php endif; ?>
                                <a href="bundle?id=<?php echo $row['id']; ?>">
