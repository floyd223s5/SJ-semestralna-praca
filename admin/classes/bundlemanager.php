...
class BundleManager {
    ...
    private function editBundle() {
        ...
        $updateSql = "UPDATE bundles SET name=?, img_path=?, price=?, sale_price=?, download_link=? WHERE id=?";
    ...
    private function deleteBundle() {
        ...
        $deleteSql = "DELETE FROM bundles WHERE id=?";
    ...
    private function addBundle() {
        ...
        $download_link = $_POST['add_download_link'];
        $sale_price = isset($_POST['add_sale_price']) ? $_POST['add_sale_price'] : null;

        $insertSql = "INSERT INTO bundles (name, img_path, price, sale_price, download_link) VALUES (?, ?, ?, ?, ?)";
        $stmt = $this->db->getConn()->prepare($insertSql);
        $stmt->bind_param("ssdds", $name, $img_path, $price, $sale_price, $download_link);
    ...
    public function renderBundleList() {
                                ...
                                <div class='modal-dialog' role='document'>
                                    <div class='modal-content'>
                                        <div class='modal-header'>
                                            <h5 class='modal-title' id='editModalLabel'>Upraviť bundle - {$row['name']}</h5>
                                        ...
                                        <div class='modal-body'>
                                            <form method='post' action=''>
                                                ...
                                                <div class='form-group'>
                                                    ...
                                                    <input type='number' class='form-control' name='sale_price' value='{$row['sale_price']}'>
                                                </div>
                                                <div class='form-group'>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="">
                            ...
                            <div class="form-group">
                                <label for="add_download_link">Download Link:</label>
                                <input type="text" class="form-control" name="add_download_link" required>
                            </div>
                            <br>
