...
class CatalogProducts {
    ...
    public static function getCatalogProducts(Database $db, $sortOption) {
        $conn = $db->getConn();
        ...
        while ($row = $result->fetch_assoc()) {
            $products[] = new CatalogProducts($row['id'], $row['name'], $row['img_path'], $row['price'], $row['sale_price']);
        }
        return $products;
    }

    public function renderCatalogProducts() {
